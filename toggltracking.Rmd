...
```{r}
message("File exists: ", file.exists("API/toggl_API.txt"))
message("Files deployed:")
message(paste(list.files(recursive = TRUE), collapse = "\n"))

api_token <- trimws(readLines("API/toggl_API.txt"))
message("Token length: ", nchar(api_token))
```
